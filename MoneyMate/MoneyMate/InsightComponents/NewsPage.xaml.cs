	...
	public partial class NewsPage : ContentPage
	{
		...
		private async void GetNews()
		{
			...
			var request = new HttpRequestMessage
			{
				...
				RequestUri = new Uri("https://reuters-business-and-financial-news.p.rapidapi.com/articles-by-trends/2024-04-16/0/70"),
				Headers =
				{
					{ "X-RapidAPI-Key", "c9dea34e94mshd6112f32d4ea4d0p1d191cjsn7e9391501b9d" },
